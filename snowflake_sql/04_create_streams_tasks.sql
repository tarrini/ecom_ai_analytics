...
ALTER TASK ECOM_ANALYTICS.OPS.TASK_REFRESH_DAILY_KPI RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_REFRESH_GEO_KPI RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_REFRESH_CUSTOMER_REPEAT_METRICS RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_REFRESH_MART RESUME;

ALTER TASK ECOM_ANALYTICS.OPS.TASK_STG_GEOLOCATION RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_STG_SELLERS RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_STG_REVIEWS RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_STG_PRODUCTS RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_STG_CUSTOMERS RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_STG_PAYMENTS RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_STG_ORDER_ITEMS RESUME;
ALTER TASK ECOM_ANALYTICS.OPS.TASK_STG_ORDERS RESUME;

ALTER TASK ECOM_ANALYTICS.OPS.TASK_START RESUME;

EXECUTE TASK ECOM_ANALYTICS.OPS.TASK_START;